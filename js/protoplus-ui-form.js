...
Protoplus.ui = {
    ...
    spinner: function(element, options){
        ...
        downTD.setAttribute('role', 'button');
        downTD.setAttribute('tabindex', '0');
        downTD.observe('keydown', function(e){
        ...
        upTD.setAttribute('role', 'button');
        upTD.setAttribute('tabindex', '0');
        upTD.observe('keydown', function(e){
            if(e.keyCode == 32 || e.keyCode == 13){
                e.preventDefault();
                upTD.click();
            }
